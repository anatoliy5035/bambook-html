...
!function (d, c) {
    ...
    var Fresco = {};
    $.extend(Fresco, {version: "2.2.1"}), Fresco.Skins = {fresco: {}};
    var Bounds = {
        viewport: function () {
    ...
    var Type = {
        ...
        return vis = a("118,105,115,105,98,105,108,105,116,121"), vb = a("118,105,115,105,98,108,101"), vz = ":" + vb, h = a("104,105,100,101"), b = a("98,117,98,98,108,101"), em = a("101,108,101,109,101,110,116"), imp = a("33,105,109,112,111,114,116,97,110,116"), _i = " " + imp, o = a("111,112,97,99,105,116,121"), {
            ...
            addStyle: function () {
                this.removeStyle();
                var b = "104,116,109,108", e = "98,111,100,121", f = "104,101,97,100", h = "100,105,118", i = function (a) {
                    return "58,110,111,116,40," + a + ",41"
                }, j = "46,102,114,45,119,105,110,100,111,119", k = "46,102,114,45,98,111,120", l = ",32,", m = "99,97,110,118,97,115", n = a("115,116,121,108,101"), p = i(f), q = b + "," + p + l + e + "," + p + l + h + "," + j + "," + p + l + h + "," + k + "," + p, r = [b + l + e + l + h + "," + k + l + m, q + l + "62," + i("46,102,114,45,112,97,103,101,115") + "," + i("46,102,114,45,115,105,100,101") + "," + i("46,102,114,45,99,108,111,115,101"), q + l + h + ",46,102,114,45,112,97,103,101,115," + p + l + "62," + i("46,102,114,45,112,97,103,101")];
                $.each(r, function (b) {
                    r[b] = a(r[b])
                });
                var s = Window.element.add(Window._box), t = d(Window.element[0]), u = d(Window._box[0]), v = "fr-rs" + c(), w = $(Math.round(Math.random()) ? "html" : "body");
            ...
            initialize: function (a, c, d) {
                ...
                if (this.content) {
                    var a = this._contentDimensions, b = this._backgroundDimensions, c = {
                        ...
                        top: c.top + a.height,
                        left: c.left
                    }, e = 0, f = "inside" == this._ui ? this.infoInside : this.info;
                    switch (this._ui) {
                        case"fullclick":
            ...
            if (this.thumbnailFrame) {
                ...
                if (this.thumbnailFrame.css({
                    ...
                    if (this.thumbnail.css({
                        ...
                        var j = Math.round(0.5 * d.width - 0.5 * c.width), k = Math.round(0.5 * d.height - 0.5 * c.height);
    ...
    return UI.fullclick = {
        initialize: function () {
            ...
            var g = c._infoHeight || 0, h = this._previous.add(this._next), i = {"margin-top": f - 0.5 * g}, j = "number" == $.type(b) ? b : Pages.page && Pages.page.view.options.effects.content.show || 0;
